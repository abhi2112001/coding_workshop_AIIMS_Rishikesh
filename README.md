In the workshop for 12/09/22 we made a Telegram Book Bot, which takes data from libgen and sends the details of the book alongwith link to download it to the user on Telegram
